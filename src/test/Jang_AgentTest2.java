...
public class Jang_AgentTest2 extends ArbiAgent{
	...
	Jang_AgentTest2(){
		ArbiAgentExecutor.execute("tcp://169.254.5.157:61616","sa://kist.re.kr/jang2", this);
	}
	...
	public void onStart(){
		...
		request("sa://kist.re.kr/jang1","(RequestTest \"testValue\")");
		
		dc.assertFact("(SubscribeTest \"notificationValue\")");
		//this.query("sa://kist.re.kr/jang1", "(testQuery)");
//		while(true) {

...
public class Jang_AgentTest1 extends ArbiAgent{
	...
	Jang_AgentTest1(){
		ArbiAgentExecutor.execute("tcp://169.254.5.157:61616","sa://kist.re.kr/jang1", this);
	}
	...
	public void onStart(){
		...
		//this.query("sa://kist.re.kr/jang2", "(testQuery)");
//		while(true) {

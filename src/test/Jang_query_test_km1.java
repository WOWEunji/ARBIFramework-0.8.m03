...
public class Jang_query_test_km1 extends ArbiAgent{
	...
	public void onStart(){
		...
		this.query("sa://kist.re.kr/km","(Location_axis \"" +getTime()+ "\" 308 \"안방\")");
		System.out.println("장소 중심 좌표 요청"); 
		sleepCommand(1000);
		//KM -> CM으로 넘어가는 과정에서 멈춤
		
		this.query("sa://kist.re.kr/km","(Task_preference_capability \"" +getTime()+ "\" 308 \"" +user+ "\" \"약먹기\")");

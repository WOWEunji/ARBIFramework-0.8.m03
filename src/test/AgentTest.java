...
public class AgentTest extends ArbiAgent{
	...
	public void onStop(){}
	public String onRequest(String sender, String request){return"(Speak_gesture_face a b c d)";}
	...
	AgentTest(){
		ArbiAgentExecutor.execute(MybomConfigure.ArbiHost(),"sa://kist.re.kr/action", this);
	}

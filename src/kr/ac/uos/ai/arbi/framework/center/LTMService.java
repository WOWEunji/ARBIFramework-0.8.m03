...
public class LTMService {
	...
	public LTMService() {
		queryClient = RedisClient.create("redis://localhost:6379/0");
		StatefulRedisConnection<String, String> connection = queryClient
				.connect();
	...
	public String match(String author, String fact) {
		...
		PredicateContainer queried = queryMatchData(p);
		if (queried != null) {
	...
	public String updateFact(String author, String fact) {
		...
		PredicateContainer queried = queryMatchData(before);

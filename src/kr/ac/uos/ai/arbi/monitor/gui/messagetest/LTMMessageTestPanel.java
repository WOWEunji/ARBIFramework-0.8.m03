...
public class LTMMessageTestPanel extends AbstractNullLayoutPanel {
	...
	private static final String DEFAULT_JMS_URL = "tcp://169.254.5.157:61616";
	private static final String DEFAULT_SENDER_URL = "dc:testdc1";
	private static final String DEFAULT_AGENT_URL = "tcp://169.254.5.157:61616";
	...
	LTMMessageTestPanel(String brokerURL) {
		...
		this.senderPanel = new JPanel();
		this.jmsURLTF = new LabeledTextField("JMS URL: ", 90, "tcp://169.254.5.157:61616");
		this.senderURLTF = new LabeledTextField("Sender URL: ", 90, "dc:testdc1");
		this.arbiURLTF = new LabeledTextField("ARBI URL: ", 90, "tcp://169.254.5.157:61616");

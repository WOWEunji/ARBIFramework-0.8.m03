...
//		this.brokerURLTF = new LabeledTextField("JMS Broker : ", "tcp://127.0.0.1:61616");
		this.brokerURLTF = new LabeledTextField("JMS Broker : ", "tcp://"+MybomConfigure.localIP()+":61616");	///< 20191002 박동현 수정
